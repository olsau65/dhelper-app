...
class Inspection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    msg1 = 'Досмотр — это не только визуальное обследование машины и груза. Т.е. можно трогать и проверять содержимое и элементы автомобиля. \n\n' +
    ...
    'Видеосъемка: если это не спецоперация с законным запретом на съемку, документами и основаниями, снимать можно все — от первого слова инспектора до подписи протокола. Как инспектор досматривает машину, что находит и что делают понятые, тоже можно снимать на свой телефон.\n\n' +
